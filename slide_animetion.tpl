...
.slideContets section h1 {
  transform: translateX(400px);
}


.slideContets section p {
  transform: translateX(200px);
}

#switch1:checked ~ #slideshow .slideContents #slide1 h1,
#switch1:checked ~ #slideshow .slideContents #slide1 p {
...
<div id="slideshow">
  <div class="slideContents">
    <section id="slide1">
      <div class="contents">
        <h1>h_animetion_test</h1>
        <p>p_animetion_test</p>
        <img src="http://placehold.it/600x200/fafafa/20b2aa/&text=slide_1">
      </div>
    </section>
    <section id="slide2">
      <div class="contents">
        <h1>h_slide2_animetion_test</h1>
        <p>p_slide2_animetion_test</p>
        <img src="http://placehold.it/600x200/fafafa/20b2aa/&text=slide_2">
      </div>
    </section>
    <section id="slide3">
      <div class="contents">
        <h1>h_slide3_animetion_test</h1>
        <p>p_slide3_animetion_test</p>
