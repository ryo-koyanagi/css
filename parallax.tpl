...
<div id="wrapper">
  ...
  <nav class="menu">
    ...
    <ul>
      ...
      <li><a href="#article3">■ webサイトの作りかた</a></li>
      <li><a href="#article4">■ photoshopのシェイプ</a></li>
      <li><a href="#article5">■ スライドショー作成</a></li>
    </ul>
  </nav>
    ...
    <article>
      ...
      <section id="article4">
        ...
        <figure>
          ...
          <figcaption>photoshopの万能シェイプいついてのまとめです
          <a href="#">この記事を読む</a></figcaption>
        </figure>
      </section>

      <section id="article5">
        <h2>cssだけでスライドショーは作れるよ</h2>
        <figure>
          <img src="http://lopan.jp/wp/wp-content/uploads/2012/12/title.jpg">
          <figcaption>前回の記事をcssだけで実装してみました
          <a href="#">この記事を読む</a></figcaption>
        </figure>
      </section>
